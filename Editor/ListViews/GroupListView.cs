...
namespace Svelto.ECS.Debugger.Editor.ListViews
{
    public class GroupListView : TreeView
    {
        ...
        private ListViewNode rootNode;
        private RootSelectionGetter _rootSelectionGetter;
        private GroupSelectionCallback _groupSelectionCallback;
        private readonly Dictionary<int, DebugGroup> groupsById = new Dictionary<int, DebugGroup>();
